'''
Current clamp demo using Allen Brain's model 472299363.
...
from neuron472299363 import Neuron472299363
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472299363(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472299363; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-80.3195063273)
        h.fcurrent()
